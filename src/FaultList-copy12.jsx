...
export default function FaultList() {
  ...
  const calculateDurationHHMM = (handoverStr, clearanceStr) => {
    try {
      const start = handoverStr ? new Date(handoverStr) : null;
      const end = clearanceStr ? new Date(clearanceStr) : null;
    ...
    <div style={{ padding: "2rem", fontFamily: "Arial, sans-serif" }}>
      ...
      {(() => {
        ...
        return sorted.map((item) => {
          ...
          const duration = calculateDurationHHMM(
